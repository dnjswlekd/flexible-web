<template>
  <div class="container class-detail">
    <section class="class-detail-image">
      <div class="class-detail-image-inner">
        <div class="heading">
          <h1>
            모바일 웹<br />UI/UX 디자인 및 퍼블리싱 제작,<br />필수 이론과
            노하우 및 체계적인 실전 제작
          </h1>
        ...
        <div class="class-detail-info">
          ...
          <article class="class-introduce" id="feature1">
            <div class="class-detail-header">
              <h2>클래스 소개</h2>
              <span
                >투자한 시간 만큼 충분한 결과로 나타나는 실무 경험과 노하우를
                전해드립니다.</span
              >
            </div>
            <div class="class-detail-wrap">
              <h2>
                <b>초급자</b>를 위해 준비한 <br /><b>[웹 퍼블리싱, UX/UI]</b>
                강의입니다.
              </h2>
              <p>
                퍼블리셔 취업과 퍼블리셔 실무에서 가장 경쟁력이 있는 모바일 웹
                제작 능력을 향상할 수 있습니다. 퍼블리셔로서 모바일 웹을
                제작하기 위한 거의 모든 제작 방법과 노하우를 다질 수 있습니다.
                특히 요즘 퍼블리셔와 개발자에게 요구되는 디자인 능력을
                피그마(Figma) 학습으로 많은 부분 커버할 수 있도록
                피그마(Figma)로 모바일 웹 UI 디자인 작업을 하는 과정도 상세하게
                설명하였습니다. 모바일 웹 퍼블리싱 수업에서 가장 강점인 부분인
                HTML 와이어프레임 상세한 작성법을 모든 페이지 하나하나 상세하게
                설명합니다. 강의를 통해 HTML 와이어프레임 제작 능력이 크게
                향상될 것입니다. 모바일 웹 퍼블리싱은 CSS 변수(Var) 활용한
                모바일과 태블릿에 맞춘 레이아웃을 완벽하게 맞추는 학습을 통해서
                실무 작업과 대동소이한 정도의 작업 능력을 갖추게 됩니다. Flex
                레이아웃을 중심으로 중상급 CSS 실전 능력을 충분히 갖추시게
                됩니다.
              </p>
              <div class="sub-wrap">
                ...
                <ul class="class-introduce-feature">
                  <li>
                    <em>Step 1.</em> 피그마(Figma)로 모바일 웹 UI 디자인 제작
                  </li>
                  <li>
                    <em>Step 2.</em> 모바일 웹 HTML 와이어프레임 모든 페이지
                    상세한 제작
                  </li>
                  <li>
                    <em>Step 3.</em> CSS 변수(Var) 활용한 다양한 레이아웃의 다수
                    페이지 퍼블리싱 제작
                  </li>
                  <li>
                    <em>Step 4.</em> 완성된 퍼블리싱 결과물을 더 완벽하게 하는
                    퍼블리싱 마무리 작업
                  </li>
                </ul>
                <p>
                  코딩웍스가 지금까지 수많은 오프라인 학원 학생들에게 수업한
                  모바일 웹 퍼블리싱 제작 노하우가 담겨 있습니다. 완강 후 한층
                  향상된 퍼블리싱 실력을 갖게 되실거라고 확신합니다!
                </p>
              </div>
              <div class="class-detail-wrap">
                <h3 class="sub-wrap-header">강의주제 📖</h3>
                <p>
                  코딩웍스의 [모바일 웹 퍼블리싱 포트폴리오 with Figma]를 통해서
                  퍼블리셔 취업과 퍼블리셔 실무에서 가장 경쟁력이 있는 모바일 웹
                  제작 능력을 향상할 수 있습니다. 그리고 퍼블리셔로서 모바일
                  웹을 제작하기 위한 거의 모든 제작 방법과 노하우를 다질 수
                  있습니다.
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    퍼블리셔와 개발자에게 피그마(Figma) 실전 제작으로 UI 디자인
                    능력 장착!
                  </li>
                  <li>CSS 변수(Var)를 이론 뿐만 아니라 실전에 활용</li>
                  <li>슬릭 슬라이더(Slick Slider) 사용법 및 CSS 변경 노하우</li>
                  <li>
                ...
                <ul>
                  ...
                  <li>[다운로드] HTML+CSS 모바일 목업(Mobile Mockup).zip</li>
                  <li>
                    [다운로드] 모바일 UI 디자인 소스(Today's Meal Kit) - 디자인
                    작업소스 & 완성본.zip
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>[마무리작업] 모바일 웹 퍼블리싱(수정,추가,삭제).pdf</li>
                </ul>
              </div>
            </div>
          </article>
          ...
          <article class="class-curriculum" id="feature2">
            ...
            <div class="class-detail-wrap">
              ...
              <div class="curriculum-accordion">
                <div class="accordion-item-wrap">
                  ...
                  <div class="chapter-content">
                    ...
                    <div class="chapter-content-class">
                      <div class="class-subject">
                        <i class="bi bi-play-circle"></i>절대 주소와 상대 주소의
                        개념
                      </div>
                      <div class="class-hour">
                        <span class="class-hour-detail">05:25</span>
                    ...
                    <div class="chapter-content-class">
                      <div class="class-subject">
                        <i class="bi bi-play-circle"></i>임시 이미지(placeholder
                        image) 사용하기
                      </div>
                      <div class="class-hour">
                        <span class="class-hour-detail">05:25</span>
                  ...
                  <div class="chapter-title">
                    <span class="chapter-subject"
                      >Chapter 04. 수강생 참고자료 다운로드(모바일 웹)</span
                    >
                    <span class="chapter-hour">4강의</span>
                  </div>
                  <div class="chapter-content">
                    <div class="chapter-content-class">
                      <div class="class-subject">
                        <i class="bi bi-play-circle"></i>[다운로드] 모바일 UI
                        디자인 소스(Today's Meal Kit) - 디자인 작업소스 & 완성본
                      </div>
                      <div class="class-hour">
                        <span class="class-hour-detail">05:25</span>
                      </div>
              ...
              <div class="curriculum-basic-info footer">
                강의 게시일 : 2022년 09월 29일(마지막 업데이트일 : 2022년 09월
                29일)
              </div>
            </div>
          </article>
            ...
            <div class="class-detail-wrap">
              <div class="review-group">
                  ...
                  <div class="review-diagram-group">
                    <div class="review-diagram">
                      ...
                      <div class="review-diagram-bar">
                        <span
                          class="review-diagram-bar-progress"
                          style="width: 90%"
                        ></span>
                      </div>
                    </div>
                ...
                <div class="review-focus-group">
                  <div class="review-focus">
                    ...
                    <div>
                      <b>수강기간 무제한</b>기간에 관계 없이 평생 수강 가능
                    </div>
                  </div>
                  <div class="review-focus">
              ...
              <div class="review-user-comment-group">
                <div class="review-user-comment">
                  ...
                  <div class="user-comment">
                    <div class="user-name-date">
                      ...
                      <span class="write-date">2021-01-17</span>
                    </div>
                    <span class="stars">
                      <i class="bi bi-star-fill"></i>
                      <i class="bi bi-star-fill"></i>
                ...
                <div class="review-user-comment">
                  ...
                  <div class="user-comment">
                    <div class="user-name-date">
                      <span class="user-name">병아리웹</span>
                      <span class="write-date">2021-01-17</span>
                    </div>
                    <span class="stars">
                      <i class="bi bi-star-fill"></i>
                ...
                <div class="review-user-comment">
                  ...
                  <div class="user-comment">
                    <div class="user-name-date">
                      <span class="user-name">Andy7132</span>
                      <span class="write-date">2021-01-17</span>
                    </div>
                    <span class="stars">
                      <i class="bi bi-star-fill"></i>
                ...
                <div class="review-user-comment">
                  ...
                  <div class="user-comment">
                    <div class="user-name-date">
                      <span class="user-name">Cindy343</span>
                      <span class="write-date">2021-01-17</span>
                    </div>
                    <span class="stars">
                      <i class="bi bi-star-fill"></i>
                    ...
                    <p>
                      1회차 정독하고 2회차 읽고 있습니다. 혼자 준비하는 막막한
                      개인 포폴이라서 모르고 지나가는 부분이 너무 많았네요.
                      상세하게 짚어주신 PDF 교재입니다. pdf 책 속에 있는 그대로
                      실행하려고 합니다. 감사드립니다.
                    </p>
                  </div>
                </div>
                <div class="review-user-comment">
                  ...
                  <div class="user-comment">
                    ...
                    <p>
                      1. 강의 내용이 쉽다. 2. 마크업이 깔끔하다. 매번 의미없는
                      width,height의 반복이 없다. 묻지마 그냥 이렇게 써 라는
                      식이 아니라 자세한 설 명을 들을 수 있어서 좋았다. 3.예제로
                      사용하는 와이어프레임 자체가 세련됐다. 4.이미지 슬라이드를
                      CSS만으로 작성하는 등의 새로운 방법을 배울 수 있어서
                      좋았다. 5. 질문을 할 수 있어서 좋았다.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="class-detail-wrap">
              <div class="faq-accordion">
                ...
                <div class="faq-content">
                  ...
                  사용 경험이면 충분히 따라 오실 수 있고, 기대하는 만큼의 실력
                  향상과 결과물을 얻으실 수 있습니다. 다만, CSS 중급 이론을 자주
                  사용하기 때문에 아래에 있는 학습 내용은 어느 정도 알고 있어야
                  합니다.
                </div>
                <div class="faq-title">
                ...
                <div class="faq-content">
                  ...
                  굉장히 좋습니다. 파워포인트를 어느 정도 다룰 수 있으면 충분히
                  피그마 디자인 수업을 따라오실 수 있습니다. 다만 좀 더 수업을
                  잘 소화하시기 위해서 [필독] 모바일 웹 UI 디자인 피그마(Figma)
                  기초강좌 영상을 보시고 소개한 유튜브를 통해서 선행학습을
                  하시길 바랍니다.
                </div>
                <div class="faq-title">
                ...
                <div class="faq-content">
                  ...
                  모바일 웹 UI 디자인 제작 with Figma] 피그마 디자인 작업 수업은
                  전문가를 위한 수업이라기 보다는 피그마를 처음 시작하는 사람이
                  받아들이기 무난한 수준입니다. 하지만 [섹션 2. 모바일 웹
                  퍼블리싱을 위한 HTML 와이어프레임 구조]와 [섹션 3. 모바일 웹
                  상세 퍼블리싱(HTML+CSS+JS)] 수업은 오랫동안 퍼블리싱 강의를
                  해온 강사로서 퍼블리싱 실력을 높이는 가장 확실하고 체계적인
                  방법으로 수업합니다. 그리고 모바일 웹 퍼블리싱이라는 생소하고
                  어려운 작업을 단계적으로 수준급 결과물을 이끌어 낼 수 있도록
                  제작된 수업이 핵심이라고 생각합니다.
                </div>
                <div class="faq-title">
                ...
                <div class="faq-content">
                  ...
                  피그마(Figma) 기초강좌] 영상에도 있지만 파워포인트를 잘 다루는
                  정도면 피그마 학습하고 활용하는데 전혀 지장이 없습니다. 저도
                  피그마 사용을 단기간에 해당 강의를 위해서 학습했는데도 좋은
                  디자인 결과물을 얻을 수 있었습니다.
                </div>
                <div class="faq-title">
                  <b>Q.</b>디자이너라 피그마는 잘하는데 섹션 1의 피그마 디자인을
                  학습해야 하나요?
                </div>
                <div class="faq-content">
                  소개 영상에도 언급했지만 제가 피그마(Figma)를 오래 해오거나
                  잘하는 사람은 아닙니다. 그래서 피그마 작업에 자신이 있는
                  분이면 [섹션 1. 모바일 웹 UI 디자인 제작 with Figma]은
                  지나가시고 [섹션 2. 모바일 웹 퍼블리싱을 위한 HTML
                  와이어프레임 구조]로 바로 가셔서 학습하시면 됩니다.
                </div>
                <div class="faq-title">
                ...
                <div class="faq-content">
                  모바일 웹은 개인 포트폴리오 작업물로서 가장 중요도가 높습니다.
                  그러므로 모바일 웹 작업물이 있으면 취업 경쟁력이 좋습니다.
                  취업 포트폴리오로서 역할 뿐만 아니라 대부분의 회사에서 모바일
                  웹 프로젝트를 진행하고 있고 진행하려고 합니다. 이런 회사
                  입장에서 잘 만든 모바일 웹 포트폴리오가 있다면 취업 이직의
                  아주 좋은 레퍼런스가 될 거라고 생각합니다.<br />
                  모바일 웹은 개인 포트폴리오 작업물로서 가장 중요도가 높습니다.
                  그러므로 모바일 웹 작업물이 있으면 취업 경쟁력이 좋습니다.
                  취업 포트폴리오로서 역할 뿐만 아니라 대부분의 회사에서 모바일
                  웹 프로젝트를 진행하고 있고 진행하려고 합니다. 이런 회사
                  입장에서 잘 만든 모바일 웹 포트폴리오가 있다면 취업 이직의
                  아주 좋은 레퍼런스가 될 거라고 생각합니다.
                </div>
                <div class="faq-title">
                  <b>Q.</b>수업 내용을 어느 수준까지 다루나요?
                </div>
                <div class="faq-content">
                  모바일 웹 특성상 파일의 개수와 폴더이 개수가 많습니다. 그래서
                  좀 속도감 있게 많은 내용이 진행됩니다. 어느 수준까지라는게
                  사람의 기준에 따라 다르지만 퍼블리셔 개인 포트폴리오로서
                  충분한 수준으로 작업하는 수업 내용입니다. 뿐만 아니라 실무에서
                  모바일 웹 작업하는 수준으로 보셔도 충분한 정도의
                  수업내용입니다.
                </div>
                <div class="faq-title">
                ...
                <div class="faq-content">
                  ...
                  충분한 강의시간으로 준비되어 있습니다. 전체적으로 퍼블리싱을
                  위한 준비작업과 퍼블리싱 작업이 전체의 80% 가까운 비중으로
                  18시간 정도입니다. 피그마 UI 디자인 - 5시간 40분 / HTML
                  와이어프레임 구조 - 4시간 30분 / 퍼블리싱 - 14시간 15분
                </div>
                <div class="faq-title">
                ...
                <div class="faq-content">
                  ...
                  설명없이 지나가지 않고 상세하게 설명합니다. 잘 따라 오실거라고
                  생각합니다. 다만 싱글 모니터로 학습하시는 것 보다 듀얼 모니터
                  환경을 갖추시길 강력하게 권합니다. 섹션 2의 [필독] 노력 대비
                  퍼블리싱 실력이 늘지 않는 이유 영상에 자세히 나와 있으니
                  참고해주세요.
                </div>
              </div>
            </div>
            ...
            <div class="class-detail-wrap">
              <div class="mentor-profile-summary">
                ...
                <div class="mentor-class-button">
                  <button class="btn-mentor-profile">강의수<em>17</em></button>
              ...
              <div class="mentor-profile-career">
                <div class="mentor-profile-header">
                  <h4>대표 멘토링 분야</h4>
                  <span
                    >UI/UX 디자인 및 퍼블리싱, 웹디자인 기능사 자격증 실기</span
                  >
                </div>
                <div class="mentor-profile-history">
                  <h4>주요 경력</h4>
                  <ul>
                    ...
                    <li>프론트엔드 퍼블리셔, 프론트엔드 퍼블리싱 전문강사</li>
          ...
          <div class="class-required-info">
            ...
            <div class="class-detail-sidebar-wrap group-main-action">
              ...
              <div class="cart-confirm-wrap">
                <button class="btn-primary btn-cart">
                  클래스 장바구니 담기
                </button>
            ...
            <div class="class-detail-sidebar-wrap group-sub-action">
              <button class="btn-sidebar-badge zzim">
                <i class="bi bi-heart"></i>236
              </button>
              <button class="btn-sidebar-badge">
                <i class="bi bi-box2-heart"></i>선물하기
              </button>
              <button class="btn-sidebar-badge share">
            ...
            <a href="#none" class="btn-mentor-follow">클래스 멘토 팔로우</a>
            <div class="class-detail-sidebar-wrap group-inquire">
              <a href="#none" class="btn-inquire"
                >수강 전에 궁금한 내용 1대1 문의하기</a
              >
            </div>
          </div>
        </div>
  ...
  <!-- Class Share Modal -->
  <div class="class-share-overlay">
    <div class="class-share">
      <h2>공유하기</h2>
      <div class="share-choice-items">
        <div class="share-choice-item">
          <i class="bi bi-facebook"></i><span>페이스북</span>
        </div>
        <div class="share-choice-item">
          <i class="bi bi-twitter"></i><span>트위터</span>
        </div>
        <div class="share-choice-item">
          <i class="bi bi-chat-fill"></i><span>카카오톡</span>
        </div>
        <div class="share-choice-item share-link">
          <i class="bi bi-link"></i><span>링크 복사</span>
          <div class="copied-link">주소가 복사되었습니다</div>
        </div>
      </div>
  ...
  <!-- Go to top -->
  <button class="gototop" :class="{ active: isVisible }" @click="goToTop">
...
const handleScroll = () => {
  if (window.scrollY > 700) {
    isVisible.value = true; // 스크롤이 700px 이상일 때 버튼을 보여줌
  } else {
    isVisible.value = false; // 스크롤이 700px 이하일 때 버튼을 숨김
  }
};

// 페이지 맨 위로 부드럽게 스크롤하는 함수
const goToTop = () => {
